...
<ModelInfo
  ...
  knownLimitations={[
  <span>
  Reasoning is enabled by default for this model. To disable it, see the <a href="/capabilities/reasoning#glm:-disable_reasoning" className="font-semibold text-black underline underline-offset-4 decoration-2 hover:text-orange-500 hover:decoration-4" style={{ textDecorationColor: '#f97316' }}>reasoning guide</a>.
  </span>,
  <span>
